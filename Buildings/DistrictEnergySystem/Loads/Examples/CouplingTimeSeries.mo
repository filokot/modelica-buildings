...
equation
  ...
  connect(couHea.heaPorLoa, bui.heaPorHea) annotation (Line(points={{-10,40},{-10,
          -22},{38,-22},{38,-23}}, color={191,0,0}));
  ...
  connect(bui.yHea, couHea.y) annotation (Line(points={{61.1,-23},{72,-23},{72,
          -8},{-30,-8},{-30,42},{-21,42}}, color={0,0,127}));
  connect(bui.yCoo, couCoo.y) annotation (Line(points={{61.1,-37},{72,-37},{72,
          -74},{-28,-74},{-28,-82},{-21,-82}}, color={0,0,127}));
  annotation (Diagram(
