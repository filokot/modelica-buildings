...
model CouplingTimeSeries "Example illustrating the coupling of a time series building model to a fluid loop"
  ...
  Buildings.DistrictEnergySystem.Loads.Examples.BaseClasses.TimeSeriesBuilding bui
...
equation
  ...
  Diagram(
    ...
    __Dymola_Commands(file="Resources/Scripts/Dymola/DistrictEnergySystem/Loads/Examples/CouplingTimeSeries.mos"
    "Simulate and plot"));
