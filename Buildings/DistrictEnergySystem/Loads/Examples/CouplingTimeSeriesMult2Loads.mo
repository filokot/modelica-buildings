...
model CouplingTimeSeriesMult2Loads
  ...
  Buildings.DistrictEnergySystem.Loads.BaseClasses.HeatingOrCoolingMult couHea(
    ...
    T_a_nominal=318.15,
    T_b_nominal=313.15)                      annotation (Placement(transformation(extent={{-20,36},{0,20}})));
  Buildings.DistrictEnergySystem.Loads.BaseClasses.HeatingOrCoolingMult couCoo(
    ...
    T_a_nominal=280.15,
    T_b_nominal=285.15)  annotation (Placement(transformation(extent={{-20,-96},{0,-80}})));
equation
  ...
  annotation (Diagram(
    ...
    __Dymola_Commands(file="Resources/Scripts/Dymola/DistrictEnergySystem/Loads/Examples/CouplingTimeSeriesMult2Loads.mos"
        "Simulate and plot"));
