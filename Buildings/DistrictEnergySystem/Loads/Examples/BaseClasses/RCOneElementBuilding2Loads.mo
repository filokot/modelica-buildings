...
model RCOneElementBuilding2Loads "Building model of type RC one element"
  import Buildings;
  ...
  Buildings.Controls.OBC.CDL.Continuous.Sources.Sine sin(
    amplitude=500,
    freqHz=1/86400,
    offset=500) annotation (Placement(transformation(extent={{-8,188},{12,208}})));
equation
  ...
  connect(gai.y, Q_flowHeaReq[1]) annotation (Line(points={{1,130},{152,130},{152,95},{310,95}},   color={0,0,127}));
  ...
  connect(sin.y, Q_flowHeaReq[2]) annotation (Line(points={{13,198},{158,198},{158,105},{310,105}}, color={0,0,127}));
  connect(sin.y, heaLoaODE[1].Q_flowReq)
    annotation (Line(points={{13,198},{39.5,198},{39.5,97},{-198,97}}, color={0,0,127}));
  annotation (Diagram(coordinateSystem(extent={{-300,-300},{300,300}})), Icon(
        coordinateSystem(extent={{-100,-100},{100,100}})));
end RCOneElementBuilding2Loads;
