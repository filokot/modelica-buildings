within Buildings.DistrictEnergySystem.Loads.Examples.BaseClasses.GeojsonExport;
model B5a6b99ec37f4de7f94020090_Storage
  ...
  thermalZoneTwoElements(
    ...
    nOrientations=6,
    AWin={44.728617934666985, 0.0, 44.728617934666985, 4.146071600551982, 0.0, 4.146071600551982},
    ATransparent={44.728617934666985, 0.0, 44.728617934666985, 4.146071600551982, 0.0, 4.146071600551982},
    AExt={134.185853804001, 273.48067614000007, 134.185853804001, 12.438214801655947, 273.48067614000007, 12.438214801655947})
    "Thermal zone"
  ...
  Buildings.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    ...
    wfWall={0.15582361279765056, 0.2967672829195335, 0.15582361279765056, 0.014443903825944526, 0.0, 0.014443903825944526},
    wfWin={0.4575846758314, 0.0, 0.4575846758314, 0.04241532416859994, 0.0, 0.04241532416859994},
    withLongwave=true,
    aExt=0.5,
  ...
  Modelica.Blocks.Sources.Constant alphaWall(k=25.000000000000004*840.2094894913139)
    ...
    rotation=90,
    origin={30,-16})));
  Modelica.Blocks.Sources.Constant alphaWin(k=25.000000000000004*97.74937907043793)
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
      ...
      fileName=Modelica.Utilities.Files.loadResource(
          "modelica://Buildings/DistrictEnergySystem/Loads/Examples/BaseClasses/GeojsonExport/InternalGains_B5a6b99ec37f4de7f94020090Storage.mat"),
      columns={2,3,4})
...
equation
  ...
  events=false));
end B5a6b99ec37f4de7f94020090_Storage;
