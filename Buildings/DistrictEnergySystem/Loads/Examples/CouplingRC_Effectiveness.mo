...
model CouplingRC_Effectiveness "Example illustrating the coupling of a RC building model to a fluid loop"
  import Buildings;
...
equation
  ...
  connect(bui.yCoo, mFloCoo.u) annotation (Line(points={{61,-37},{72,-37},{72,
          -60},{-102,-60},{-102,-82},{-90,-82}},   color={0,0,127}));
  connect(bui.yHea, mFloHea.u) annotation (Line(points={{61,-23},{72,-23},{72,0},
  ...
  connect(bui.yHea, couHea.y)
    annotation (Line(points={{61,-23},{72,-23},{72,0},{-32,0},{-32,22},{-22,22}}, color={0,0,127}));
  ...
  annotation (Diagram(
    ...
    __Dymola_Commands(file="Resources/Scripts/Dymola/DistrictEnergySystem/Loads/Examples/CouplingRC_Effectiveness.mos"
        "Simulate and plot"));
end CouplingRC_Effectiveness;
