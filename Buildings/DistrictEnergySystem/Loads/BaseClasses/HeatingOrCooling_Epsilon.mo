...
model HeatingOrCooling_Epsilon
  ...
  Buildings.DistrictEnergySystem.Loads.BaseClasses.HeatFlowEpsilon heaFloEps(
    redeclare final package Medium = Medium,
    final m_flow_nominal=m_flow_nominal);
  HeatFlowEpsilon heaFloEps1(redeclare package Medium = Medium)
...
equation
  ...
  connect(res.port_b, heaFloEps1.port_a) annotation (Line(points={{-40,0},{-20,0}}, color={0,127,255}));
  connect(heaFloEps1.port_b, vol.ports[1]) annotation (Line(points={{0,0},{32,0}}, color={0,127,255}));
  connect(vol.ports[2], port_b) annotation (Line(points={{28,0},{100,0}}, color={0,127,255}));
  connect(actUA.y, heaFloEps1.UA)
    annotation (Line(points={{41,50},{60,50},{60,-20},{-32,-20},{-32,8},{-22,8}}, color={0,0,127}));
  connect(heaFloEps1.heaPor, heaPorLoa)
    annotation (Line(points={{-10,-8},{-10,-40},{80,-40},{80,100},{0,100}}, color={191,0,0}));
   annotation (Placement(transformation(extent={{-20,10},{0,-10}})),
